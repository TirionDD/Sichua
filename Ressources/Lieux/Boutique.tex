...
\fbox{%
  \begin{minipage}[c]{.45\linewidth}
    ...
    \noindent\rule{\textwidth}{1pt} \\
    {\bfseries Jets de sauvegarde} Int +?, Sag +?\\
    {\bfseries Compétences} Arcanes +? (expert), Histoire +? (expert), Intuition +?, Persuasion +?\\
    {\bfseries Sens} Perception passive ? \\
   ...
   \noindent\rule{\textwidth}{1pt} \\
    {\bfseries Sorts.} Hella est une lanceuse de sorts de niveau 13. Sa caractéristique pour lancer 
               des sorts est l'Intelligence (sauvegarde contre ses sorts DD ??, +?? au toucher avec des 
